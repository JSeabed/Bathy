...
def parseAml (raw_mess):
    ...
    if len(sLineAml) < 5:                                   # if the data is shorter then 5 blocks of data run next line
    ...
    if len(sLineAml) >= 5:                                  # if the data is longer then 3 blocks of data run next line    
        global sAml4; sAml4 = sLineAml[4]
    if len(sLineAml) >= 6:                                  # if the data is longer then 4 blocks of data run next line
        global sAml5; sAml5 = sLineAml[5]
    if len(sLineAml) >= 7:                                  # if the data is longer then 5 blocks of data run next line
        global sAml6; sAml6 = sLineAml[6]   
    if len(sLineAml) >= 8:                                  # if the data is longer then 6 blocks of data run next line
        global sAml7; sAml7 = sLineAml[7]
    if len(sLineAml) >= 9:                                  # if the data is longer then 8 blocks of data run next line  
        global sAml8; sAml8 = sLineAml[8]
    if len(sLineAml) >= 10:                                 # if the data is longer then 9 blocks of data run next line        
        global sAml9; sAml9 = sLineAml[9]
    if len(sLineAml) >= 11:                                 # if the data is longer then 9 blocks of data run next line        
        global sAml10; sAml10 = sLineAml[10]    
    if len(sLineAml) >= 12:                                 # if the data is longer then 9 blocks of data run next line        
        global sAml11; sAml11 = sLineAml[11]
    if len(sLineAml) >= 13:                                 # if the data is longer then 9 blocks of data run next line        
        global sAml12; sAml12 = sLineAml[12]
    if len(sLineAml) >= 14:                                 # if the data is longer then 9 blocks of data run next line        
        global sAml13; sAml13 = sLineAml[13]
    if len(sLineAml) >= 15:                                 # if the data is longer then 9 blocks of data run next line        
        global sAml14; sAml14 = sLineAml[14]
    if len(sLineAml) >= 16:                                 # if the data is longer then 9 blocks of data run next line        
        global sAml15; sAml15 = sLineAml[15]
    if len(sLineAml) >= 17:                                 # if the data is longer then 9 blocks of data run next line        
        global sAml16; sAml16 = sLineAml[16]
    if len(sLineAml) >= 18:                                 # if the data is longer then 9 blocks of data run next line        
        global sAml17; sAml17 = sLineAml[17]        
